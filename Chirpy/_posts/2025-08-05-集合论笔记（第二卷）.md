...
## $\mathrm {KP}^-$公理体系
$(\mathrm{KP}_{\mathcal{A}}^{- })$  语言  $\mathcal{L}$  下的集合理论  $\mathrm{KP}_{\mathcal{A}}^{- }$  是下述语句的集合:

同一律:  $\forall v_{1}\forall v_{2}((\forall v_{3}(v_{3}\in v_{1}\leftrightarrow v_{3}\in v_{2}))\rightarrow (v_{1} = v_{2}));$
...
其中  $\phi (v_{1},\dots ,v_{n},v_{n + 1})$  是一个彰显自由变元表达式,  $\forall n + 2$  并未在  $\phi$  中出现, $\phi (v_{1},\dots ,v_{n},v_{n + 2})$  是在  $\phi$  中用  $v_{n + 2}$  替换  $v_{n + 1}$  所得到的结果.

二元集合公理:  $\forall v_{1}\forall v_{2}\exists v_{3}(v_{1}\in v_{3}\land v_{2}\in v_{3})$

并集合公理:  $\forall v_{1}\exists v_{2}\forall v_{3}\in v_{1}\forall v_{4}\in v_{3}(v_{4}\in v_{2})$
...
其中  $\phi (v_{1},\dots ,v_{n},v_{n + 1})$  是一个彰显自由变元的  $\Delta_{0}(\mathcal{A})$ - 表达式,变元符号  $v_{n + 3}$  和  $v_{n + 4}$  并未在  $\phi$  中出现, $\phi (v_{1},\dots ,v_{n},v_{n + 4})$  是在  $\phi$  中用  $v_{n + 4}$  替换  $v_{n + 1}$  所得到的结果;
...
其中  $\phi (v_{1},\dots ,v_{n},v_{n + 1},v_{n + 2},v_{n + 3})$  是一个彰显自由变元的  $\Delta_{0}(\mathcal{A})$ - 表达式,变元符号  $v_{n + 4}$  并未在  $\phi$  中出现.

定义1.7(1)当  $\mathcal{A} = \{\in \}$  时,用  $\mathrm{KP}^{- }$  来记  $\mathrm{KP}_{\mathcal{A}}^{- }$ ;

(2) 用  $\mathrm{KP}_{A}$  来记理论  $\mathrm{KP}_{A}^{-}$  加上如下形式的无穷公理所得到的理论:
