...
$$
T_\alpha=T_{\gamma+1}=\{g\cup\{(\gamma,n)\}\mid g\inT_\gamma\wedge n\in(\omega-\mathrm{rng}(g))\}
$$
...
$$
T_\alpha=\left\{f(g,X)\mid\left|\mid g\in\bigcup\limits_{\beta<\alpha}T_\beta\wedge X\in[\omega-\mathrm{rng}(g)]^{<\omega}\right\}
$$
